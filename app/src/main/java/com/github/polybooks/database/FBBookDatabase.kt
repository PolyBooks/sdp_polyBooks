 ...
 * */
class FBBookDatabase(firebase : FirebaseFirestore, private val isbnDB : BookDatabase) :
    BookDatabase() {
    ...
    */
    ...
    override fun execute(bookQuery: BookQuery): CompletableFuture<List<Book>> {
        val isbns = bookQuery.isbns
        val title = bookQuery.title
        val interests = bookQuery.interests
        ...
        when {
            ...
            isbns != null -> {
                ...
                return booksFromFBFuture.thenCompose { booksFromFB ->
                    ...
                    val booksFromOLFuture = isbnDB.execute(BookQuery(remainingISBNs))
