...
abstract class SaleDatabase {
     ...
     * */
    abstract fun execute(saleQuery : SaleQuery): CompletableFuture<List<Sale>>
 ...
 * Each field, except ordering is a filter. By default, a SaleQuery doesn't filter any sales
