...
class OLBookDBTests {
    ...
    fun getNalsoWorks2() {
        val olDB = OLBookDatabase(url2json)
        val future =
            olDB.queryBooks().searchByISBN(setOf("9781985086593", "9782376863069")).getN(1, 1)
        val books = future.get()
        assertEquals(1, books.size)
        val book = books[0]
        assertEquals("Liavek", book.title)
    ...
    fun getNalsoWorks3() {
        val olDB = OLBookDatabase(url2json)
        val future =
            olDB.queryBooks().searchByISBN(setOf("9781985086593", "9782376863069")).getN(1, 0)
        val books = future.get()
        assertEquals(1, books.size)
        val book = books[0]
    ...
    fun getNalsoWorks4() {
        val olDB = OLBookDatabase(url2json)
        val future =
            olDB.queryBooks().searchByISBN(setOf("9781985086593", "9782376863069")).getN(4, 0)
        val books = future.get()
    ...
    fun getMultipleBooksWorks() {
        val olDB = OLBookDatabase(url2json)
        val future =
            olDB.queryBooks().searchByISBN(setOf("9782376863069", "9781985086593")).getAll()
        val books = future.get()
        assertEquals(2, books.size)
    }
    ...
    fun getMultipleBooksWorks2() {
        val olDB = OLBookDatabase(url2json)
        val future =
            olDB.queryBooks().searchByISBN(setOf("9782376863069", "9781985086593", "1234567890666"))
                .getAll()
        val books = future.get()
        assertEquals(2, books.size)
    }
