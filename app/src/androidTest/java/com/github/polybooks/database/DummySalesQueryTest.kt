...
import com.github.polybooks.database.implementation.DummySalesQuery
...
class DummySalesQueryTest {
    ...
    val default_sale: List<Sale> = listOf(
            Sale( anonymousBook("Book1"), LocalUser, 23.00f, BookCondition.GOOD, com.google.firebase.Timestamp(
                com.github.polybooks.database.implementation.format.parse("2016-05-05")!!), SaleState.ACTIVE, null),
            ...
            Sale(anonymousBook("Book5"), LocalUser, 21.00f, BookCondition.WORN, com.google.firebase.Timestamp(
                com.github.polybooks.database.implementation.format.parse("2016-05-05")!!), SaleState.CONCLUDED, null),
            ...
            Sale(anonymousBook("Book9"), LocalUser, 25.00f, BookCondition.GOOD, com.google.firebase.Timestamp(
                com.github.polybooks.database.implementation.format.parse("2016-05-05")!!), SaleState.RETRACTED, null),
    )
